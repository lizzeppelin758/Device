...
* Студент: Елизавета Романова.
* Наставник: `Неизвестно`.

Этот учебный проект создан в процессе прохождения профессии "Frontend-разработчик" в онлайн-школе HTML Academy на основе учебных материалов и макета проекта, предоставленного для самостоятельной работы. 
На главной странице активны попапы корзины и каталога. При нажатии на ссылку "Каталог" происходит переход на вторую страницу из макета. 
Макет сверстан на чистых HTML и CSS, без использования скриптов. 

Вся информация ниже дана онлайн-школой как справочная для начала работы с проектом.
